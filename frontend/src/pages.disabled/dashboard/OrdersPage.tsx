...
export default function OrdersPage() {
  ...
  const updateOrderStatus = async (orderId: string, newStatus: string) => {
    try {
      // This would typically call an API endpoint to update the order status
      ...
      await fetchOrders(currentPage, statusFilter || undefined);
    } catch (err) {
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{order.metadata?.customerPhone || 'N/A'}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Mail className="h-4 w-4 text-muted-foreground" />
                          <span>{order.metadata?.customerEmail || 'N/A'}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <MapPin className="h-4 w-4 text-muted-foreground" />
                          <span>{order.metadata?.customerAddress || 'N/A'}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{order.delivery?.carrier || 'Standard Delivery'}</span>
                        </div>
                        {order.delivery?.eta && (
                          <div className="flex items-center gap-2">
