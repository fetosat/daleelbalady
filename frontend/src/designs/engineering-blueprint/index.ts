/**
 * Engineering Blueprint Design Export
 * 
 * Technical and modern design with engineering-inspired elements
 */
...
export const designMetadata = {
  ...
  description: 'Technical and modern design with engineering-inspired elements',
  version: '1.0.0',
