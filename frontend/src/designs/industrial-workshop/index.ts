/**
 * Industrial Workshop Design Export
 * 
 * Industrial-strength design with metallic accents and bold typography
 */
...
export const designMetadata = {
  ...
  description: 'Industrial-strength design with metallic accents and bold typography',
  version: '1.0.0',
