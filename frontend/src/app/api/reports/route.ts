...
export async function POST(request: NextRequest) {
  try {
    console.log('🔧 Reports API Route - POST request');
    
    const url = `${BACKEND_API_URL}/api/reports`;
    ...
    console.log('✅ Reports API Route - POST request successful');
    
    return NextResponse.json(data);
  } catch (error) {
    console.error('❌ Reports API Route - POST error:', error);
    return NextResponse.json(
